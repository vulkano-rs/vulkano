...
enumeration! {
    ...
    typedef enum StorageClass_ {
        ...
        StorageClassCallableData = 5328,
        StorageClassIncomingCallableData = 5329,
        StorageClassRayPayload = 5338,
        StorageClassHitAttribute = 5339,
        StorageClassIncomingRayPayload = 5342,
        StorageClassShaderRecordBuffer = 5343,
    } StorageClass;
