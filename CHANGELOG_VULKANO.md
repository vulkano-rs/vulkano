...
- Added `PartialEq`, `Eq` and `Hash` implementations for `Device`, `dyn BufferAccess`, `dyn ImageAccess`, `dyn ImageViewAccess`, `GraphicsPipeline`, `dyn GraphicsPipelineAbstract` and various buffer and image types.
