...
impl DebugCallback {
    ...
    pub fn new<F>(instance: &Arc<Instance>, messages: MessageTypes, user_callback: F) -> Result<DebugCallback, DebugCallbackCreationError>
        where F: Fn(&Message) + 'static + panic::RefUnwindSafe
    {
        ...
        extern "system" fn callback(ty: vk::DebugReportFlagsEXT, _: vk::DebugReportObjectTypeEXT, _: u64, _: usize, _: i32, layer_prefix: *const c_char, description: *const c_char, user_data: *mut c_void) -> u32 {
            unsafe {
        ...
        let debug_report_callback = unsafe {
            ...
            try!(check_errors(vk.CreateDebugReportCallbackEXT(instance.internal_object(), &infos, ptr::null(), &mut output)));
            output
        };
    ...
    #[inline]
    pub fn errors_and_warnings<F>(instance: &Arc<Instance>, user_callback: F) -> Result<DebugCallback, DebugCallbackCreationError>
        where F: Fn(&Message) + 'static + panic::RefUnwindSafe
    {
...
impl MessageTypes {
    ...
    pub fn errors() -> MessageTypes {
        MessageTypes { error: true, ..MessageTypes::none() }
    }
