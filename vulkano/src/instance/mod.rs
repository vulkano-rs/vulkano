...
impl Instance {
    ...
    pub unsafe fn from_handle(
        ...
        unsafe { Self::from_handle_impl(library, handle, create_info, false) }
    }
    ...
    ///   copies of the returned `Arc` must be dropped first. Note `InstanceOwned` objects all
    ///   hold a reference to the instance internally.
    pub unsafe fn from_handle_borrowed(
        library: Arc<VulkanLibrary>,
        handle: vk::Instance,
        create_info: InstanceCreateInfo,
    ) -> Arc<Self> {
        unsafe { Self::from_handle_impl(library, handle, create_info, true) }
    }
