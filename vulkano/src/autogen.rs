...
crate::device::features::features_ffi! {
    ...
    features_16bit_storage => {
        ...
        provided_by: [api_version >= crate::Version::V1_1, extensions.khr_16bit_storage],
        conflicts: [features_vulkan11],
    },
    features_multiview => {
        ty: PhysicalDeviceMultiviewFeatures,
        provided_by: [api_version >= crate::Version::V1_1, extensions.khr_multiview],
        conflicts: [features_vulkan11],
    },
    ...
    features_sampler_ycbcr_conversion => {
        ...
        provided_by: [api_version >= crate::Version::V1_1, extensions.khr_sampler_ycbcr_conversion],
        conflicts: [features_vulkan11],
    },
    ...
    features_variable_pointers => {
        ...
        provided_by: [api_version >= crate::Version::V1_1, extensions.khr_variable_pointers],
        conflicts: [features_vulkan11],
    },
    features_8bit_storage => {
        ty: PhysicalDevice8BitStorageFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_8bit_storage],
        conflicts: [features_vulkan12],
    },
    features_buffer_device_address => {
        ty: PhysicalDeviceBufferDeviceAddressFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_buffer_device_address],
        conflicts: [features_vulkan12],
    },
    features_descriptor_indexing => {
        ty: PhysicalDeviceDescriptorIndexingFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.ext_descriptor_indexing],
        conflicts: [features_vulkan12],
    },
    features_host_query_reset => {
        ty: PhysicalDeviceHostQueryResetFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.ext_host_query_reset],
        conflicts: [features_vulkan12],
    },
    features_imageless_framebuffer => {
        ty: PhysicalDeviceImagelessFramebufferFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_imageless_framebuffer],
        conflicts: [features_vulkan12],
    },
    features_scalar_block_layout => {
        ty: PhysicalDeviceScalarBlockLayoutFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.ext_scalar_block_layout],
        conflicts: [features_vulkan12],
    },
    features_separate_depth_stencil_layouts => {
        ty: PhysicalDeviceSeparateDepthStencilLayoutsFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_separate_depth_stencil_layouts],
        conflicts: [features_vulkan12],
    },
    features_shader_atomic_int64 => {
        ty: PhysicalDeviceShaderAtomicInt64Features,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_shader_atomic_int64],
        conflicts: [features_vulkan12],
    },
    features_shader_float16_int8 => {
        ty: PhysicalDeviceShaderFloat16Int8Features,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_shader_float16_int8],
        conflicts: [features_vulkan12],
    },
    features_shader_subgroup_extended_types => {
        ty: PhysicalDeviceShaderSubgroupExtendedTypesFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_shader_subgroup_extended_types],
        conflicts: [features_vulkan12],
    },
    features_timeline_semaphore => {
        ty: PhysicalDeviceTimelineSemaphoreFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_timeline_semaphore],
        conflicts: [features_vulkan12],
    },
    features_uniform_buffer_standard_layout => {
        ty: PhysicalDeviceUniformBufferStandardLayoutFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_uniform_buffer_standard_layout],
        conflicts: [features_vulkan12],
    },
    features_vulkan_memory_model => {
        ty: PhysicalDeviceVulkanMemoryModelFeatures,
        provided_by: [api_version >= crate::Version::V1_2, extensions.khr_vulkan_memory_model],
        conflicts: [features_vulkan12],
    },
