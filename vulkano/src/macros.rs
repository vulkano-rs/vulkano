    ...
    (
        ...
        mod $module_name {
            ...
            pub struct $struct_name {
                ...
                #[allow(dead_code)]
                owners: crate::aliasable_box::AliasableBox<Owners>,
            }
            ...
            impl $struct_name {
                ...
                pub fn new(
                    ...
                    let owners = crate::aliasable_box::AliasableBox::new(Owners {
                        $($owner_field_name,)+
                    });
            ...
            $(crate::macros::self_referential!(@$auto_impl $struct_name);)*
        }
