...
impl App {
    ...
    pub fn new() -> Self {
        ...
        // Here we define fields with default empty values, as we will initialize them in the
        // following function.
            ...
            Some(
                GraphicsPipeline::new(
                    ...
                    GraphicsPipelineCreateInfo {
                        ...
                        // How multiple fragment shader samples are converted to a single pixel
                        // value. The default value does not perform any
                        // multisampling.
                        multisample_state: Some(MultisampleState::default()),
                        // How pixel values are combined with the values already present in the
                        // framebuffer. The default value overwrites the old
                        // value with the new one, without any blending.
