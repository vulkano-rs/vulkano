...
fn main() {
    ...
    let (
        top_level_acceleration_structure_descriptor_set,
        ...
        let top_level_acceleration_structure_descriptor_set = PersistentDescriptorSet::new(
            ...
            Event::RedrawEventsCleared => {
                ...
                builder
                    ...
                    .bind_descriptor_sets(
                        ...
                        0,
                        top_level_acceleration_structure_descriptor_set.clone(),
                    )
                    .unwrap()
